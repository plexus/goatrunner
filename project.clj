(defproject goatrunner "0.1.0-SNAPSHOT"
  ...
  :profiles {:dev {:source-paths ["env/dev/clj"]
                   ...
                   :repl-options {:init-ns goatrunner.server
                   ...
                   :figwheel {:http-server-root "public"
                              ...
                              :ring-handler goatrunner.server/http-handler}
